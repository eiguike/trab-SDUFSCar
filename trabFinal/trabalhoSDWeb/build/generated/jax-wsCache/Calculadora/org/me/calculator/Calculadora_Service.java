 ...
 * 
 */
@WebServiceClient(name = "Calculadora", targetNamespace = "http://calculator.me.org/", wsdlLocation = "http://localhost:8080/trabalhoSD/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORA_QNAME = new QName("http://calculator.me.org/", "Calculadora");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/trabalhoSD/Calculadora?wsdl");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://calculator.me.org/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.me.org/", "CalculadoraPort"), Calculadora.class, features);
    }
